...
class MagicGui(customtkinter.CTk):
    def __init__(self):
        ...
        self.font_active_now = "Victor Mono"
        self.font_size = 11
        ...
        self.main_frame = customtkinter.CTkFrame(
            self,
            bg_color=self.colorscheme.color["normal-background"],
            fg_color=self.colorscheme.color["normal-background"],
        )

        self.left_frame = customtkinter.CTkFrame(self.main_frame, height=0,)
        ...
        self.right_frame = customtkinter.CTkFrame(
            self.main_frame, bg_color=self.colorscheme.color["normal-background"]
        )

        self.frame_top_right = customtkinter.CTkFrame(
            self.right_frame,
            bg_color=self.colorscheme.color["normal-background"],
            height=0,
        )
        ...
        self.menu_file = Menu(
            self.menu, bg=MENU_BACKGROUND_COLOR, fg=MENU_FOREGROUND_COLOR, tearoff=0
        )
        self.menu_view = Menu(
            self.menu, bg=MENU_BACKGROUND_COLOR, fg=MENU_FOREGROUND_COLOR, tearoff=0
        )
        self.menu_preference = Menu(
            self.menu, bg=MENU_BACKGROUND_COLOR, fg=MENU_FOREGROUND_COLOR, tearoff=0
        )
        ...
        self.menu_preference.add_cascade(
            label="select colorscheme", menu=self.menu_colorscheme
        )
